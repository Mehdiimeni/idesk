...
if (!$rbacClass->checkPermissionPartByName('chat_center', 'inbox', 'u')) {
    exit;
}
$_SESSION['arrayComponents'] = array('lang', 'chat');
...
$_SESSION['pageUserTitle'][] = 'chat_center';
includeFiles($objFileCaller, 'chat_center');
