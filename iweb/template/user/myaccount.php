                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-white-50">
                                            ...
                                            <?php echo htmlspecialchars($userCompany, ENT_QUOTES, 'UTF-8'); ?>
                                        </div>

                                        <?php if (!empty($userUnit)) { ?>
                                            <div class="text-white-50 mt-1">
                                                <i class="ri-team-line me-1"></i>
                                                <?php echo htmlspecialchars($userUnit, ENT_QUOTES, 'UTF-8'); ?>
=======
                <div class="col-sm-12">
                    <!-- Profile -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control editField" id="mobile" name="mobile" type="tel"
                                            value="<?php echo htmlspecialchars($userMobile, ENT_QUOTES, 'UTF-8'); ?>"
                                            required>
                                    </div>
                                </div>
