$(document).ready(function () {
    ...
    loadChat(receiverId, senderId, receiverType, senderType, adminId);
        ...
        if (message && receiverId && senderId) {
            $.ajax({
                ...
                success: function () {
                    ...
                    loadChat(receiverId, senderId, receiverType, senderType, adminId); // بارگذاری دوباره چت
                },
    ...
    function loadChat(receiverId, senderId, receiverType, senderType, adminId) {
        $.ajax({
