<?php
///ipanel/controller/bi/bi_tickets.php
...
if ($rbacClass->checkPermissionOperationByName('statistics_operation')) {
    ...
    $intTotalTicket = $kpiModel->getTotalTicketsCount($start_date, $end_date);
    $statusResult = $kpiModel->getTicketStatusCount($start_date, $end_date);
    $allAdminsViewCount = $kpiModel->getActiveAdminsViewCount($start_date, $end_date);
    $priorityResult = $kpiModel->getPriorityCountByDateRange($start_date, $end_date);
