...
//page / systems / users_parts / users_groups
...
if (!$rbacClass->checkPermissionSubpartByName('users_groups', 'users_parts', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'users_groups';
includeFiles($objFileCaller, 'users_groups');
