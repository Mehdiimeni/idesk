...
//page / systems / structure / company
...
if (!$rbacClass->checkPermissionSubpartByName('company', 'structure', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'company';
includeFiles($objFileCaller, 'company');
