...
if (!$rbacClass->checkPermissionSubpartByName('admins', 'members', 'systems')) {
    exit;
}
...
function includeFiles($objFileCaller, $specificFile)
{
    ...
    $objFileCaller->includeFileWithController('.', 'member/', $specificFile);
    $objFileCaller->includeFileWithController('.', 'global/', 'page_footer');
    $objFileCaller->includeFileWithController('.', 'global/', 'page_js');
}
$_SESSION['pageTitle'][] = 'admins';
includeFiles($objFileCaller, 'admins');