...
//page / systems / users_parts / users_parts
...
if (!$rbacClass->checkPermissionSubpartByName('users_parts', 'users_parts', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'users_parts';
includeFiles($objFileCaller, 'users_parts');