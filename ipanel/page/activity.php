...
//page / systems / structure / activity
...
if (!$rbacClass->checkPermissionSubpartByName('activity', 'structure', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'activity';
includeFiles($objFileCaller, 'activity');
