...
//page / systems / users_parts / users_subparts
...
if (!$rbacClass->checkPermissionSubpartByName('users_subparts', 'users_parts', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'users_subparts';
includeFiles($objFileCaller, 'users_subparts');