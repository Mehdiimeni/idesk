...
//page / systems / admins_parts / admins_subparts
...
if (!$rbacClass->checkPermissionSubpartByName('admins_subparts', 'admins_parts', 'systems')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'admins_subparts';
includeFiles($objFileCaller, 'admins_subparts');