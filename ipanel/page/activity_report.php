...
//page / dashboard / activity_report
...
if (!$rbacClass->checkPermissionPartByName('activity_report', 'dashboard')) {
    exit;
}
...
$_SESSION['pageTitle'][] = 'activity_report';
includeFiles($objFileCaller, 'activity_report');
