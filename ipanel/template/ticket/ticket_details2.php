                        ...
                        <div class="card-body border">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <?php } else { ?>
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <?php echo _lang['please_insert_manhour_note1']; ?>
                                                </a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="" id="CardheadingOne">
                                        <a class="custom-accordion-title " data-bs-toggle="collapse" href="#collapseOne"
                                            ...
                                            <span class="float-end">
                                                <?php $dateConverter = new DateConverter($lastForwardDescription['creation_date'], $config->getNowLanguage('a'));
                                        ...
                                        <?php foreach ($allForwardDescription as $forwardsDescription) { ?>
                                            <div class="pt-1 mt-2">
                                                <a class="custom-accordion-title" data-bs-toggle="collapse" href="#collapseOne"
                                                    ...
                                                    <strong>
                                                        <?php echo htmlspecialchars($forwardsDescription['person_name']); ?>
                                                        :
                                                    </strong>
                            ...
                            <?php if (isset($response_person_hour['response']) && $response_person_hour['response'] != '' && $rbacClass->checkPermissionOperationByName('person_hour_view_operation')) { ?>
                                <div class="alert alert-light" role="alert">
                                    <?php echo ($response_person_hour['name']); ?> <a href="#" class="alert-link">
                                        <?php echo _lang['person_hour']; ?>
                                    </a> :
                                    <?php echo ($response_person_hour['response']); ?>
                                    <span class="float-end">
                                        <?php $dateConverter = new DateConverter($response_person_hour['last_updated_date'], $config->getNowLanguage('a'));
                                        echo $dateConverter->convertToShamsi(); ?>
                                    </span>
                                </div>
                            <?php } ?>
                            <?php if (isset($response_delivery_time['response']) && $response_delivery_time['response'] != '' && $rbacClass->checkPermissionOperationByName('delivery_time_view_operation')) { ?>
                                <div class="alert alert-secondary" role="alert">
                                    <?php echo ($response_delivery_time['name']); ?> <a href="#" class="alert-link">
                                        <?php echo _lang['delivery_time']; ?>
                                    </a> :
                                    <?php echo ($response_delivery_time['response']); ?>
                                    <span class="float-end">
                                        <?php $dateConverter = new DateConverter($response_delivery_time['last_updated_date'], $config->getNowLanguage('a'));
                                        echo $dateConverter->convertToShamsi(); ?>
                                    </span>
                                </div>
                            <?php } ?>
                                    ...
                                    <div class="card comment-card mb-3 <?php echo $commentBorderClass; ?>">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div>
                                                    <strong>
                                                        <?php echo htmlspecialchars($commentDetail['name'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>
                                                    </strong>
                                                    ...
                                                    <div class="card comment-card reply-card <?php echo $replyBorderClass; ?>">
                                                        <div class="card-body py-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                                <div>
                                                                    <strong>
                                                                        <?php echo htmlspecialchars($replyDetail['name'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>
                                                                    </strong>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="submitDescription" class="btn btn-primary">
                                        <?php echo (_lang['submit']); ?>
                                    </button>
                                </div>
                            </div>
