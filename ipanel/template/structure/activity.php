                            ...
                            <div class="table-responsive">
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        $activitiesResult = $structureModel->getActivities();
                                        while ($activitiesDetails = $activitiesResult->fetch_assoc()) {
                                            $dateConverter = new DateConverter($activitiesDetails['last_updated_date'], $config->getNowLanguage('a'));

                                        ?>
                                            <tr>
                                            <td>
                                                    <?php echo $activitiesDetails['id']; ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal" data-bs-target="#deleteModal" data-table="activities" data-id="<?php echo $activitiesDetails['id']; ?>">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($rbacClass->checkPermissionOperationByName('edit_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal" data-bs-target="#editModal" data-table="activities" data-id="<?php echo $activitiesDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <input type="hidden" class="form-control addField" name="table_set" id="tableSet" value="activities">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="activity_name" name="activity_name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField" id="activity_description" name="activity_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="activity_name" name="activity_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="activity_description" class="form-label"><?php echo (_lang['description']); ?>
                                                        </label>
                                                        <textarea class="form-control editField" id="activity_description" name="activity_description" required></textarea>
                                                    </div>
