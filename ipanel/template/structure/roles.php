                            ...
                            <div class="table-responsive">
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($rolesDetails = $rolesResult->fetch_assoc()) {

                                        ?>
                                            <tr>
                                                <td>
                                                    <?php echo $rolesDetails['role_name']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $rolesDetails['role_description']; ?>
                                                </td>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($rolesDetails['last_updated_date'], $config->getNowLanguage('a'));
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal" data-bs-target="#deleteModal" data-table="roles" data-id="<?php echo $rolesDetails['id']; ?>">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($rbacClass->checkPermissionOperationByName('edit_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal" data-bs-target="#editModal" data-table="roles" data-id="<?php echo $rolesDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <input type="hidden" class="form-control addField" name="table_set" id="table_set" value="roles">
                                                    <input class="form-control addField" type="hidden" name="unique_fields" id="unique_fields" value="<?php echo $unique_fields; ?>">
                                                    <div class="mb-3">
                                                        <label for="role_name" class="form-label">
                                                            <?php echo (_lang['name']); ?>
                                                        </label>
                                                        <input type="text" class="form-control addField" id="role_name" name="role_name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField" id="role_description" name="role_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="role_name" name="role_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="role_description" class="form-label">
                                                            <?php echo (_lang['description']); ?>
                                                        </label>
                                                        <textarea class="form-control editField" id="role_description" name="role_description" required></textarea>
                                                    </div>
