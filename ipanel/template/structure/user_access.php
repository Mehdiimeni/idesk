                                    ...
                                    <tbody>
                                        ...
                                        while ($rbacDetails = $rbacResult->fetch_assoc()) {
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <?php
                                                    $rbacByIdResult = $structureModel->getRBACById($rbacDetails['manager_id']);
                                                    echo !empty($rbacByIdResult['rbac_name']) ? $rbacByIdResult['rbac_name'] : "-";
                                                    ?>
                                                </td>
                                                <th>
                                                    <?php echo ($rbacDetails['activity_name']); ?>
                                                </th>
                                                ...
                                                <th>
                                                    <?php echo ($rbacDetails['unit_name']); ?>
                                                </th>
                                                <th>
                                                    <?php echo ($rbacDetails['tag_name']); ?>
                                                </th>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($rbacDetails['last_updated_date'], $config->getNowLanguage('a'));
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select  addField" name="manager_id"
                                                            id="manager_id">
                                                            <option value="0">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select addField" name="activity_id"
                                                            id="activity_id">
                                                            <option value="0">
                                                                <?php echo (_lang['activity_add']); ?>
                                                            </option>
                                                            ...
                                                            while ($activityDetails = $activityResult->fetch_assoc()) {
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $activityDetails['id']; ?>">
                                                                    <?php echo $activityDetails['activity_name']; ?>
                                                                </option>
                                                            <?php } ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select addField" name="company_id"
                                                            id="company_id">
                                                            <option value="0">
                                                                <?php echo (_lang['company_add']); ?>
                                                            </option>

                                                            <?php
                                                            $companyResult = $structureModel->getCompanies();
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select addField" name="unit_id"
                                                            id="unit_id">
                                                            <option value="0">
                                                                <?php echo (_lang['unit_add']); ?>
                                                            </option>

                                                            <?php
                                                            $unitResult = $structureModel->getUnits();
                                                            while ($unitDetails = $unitResult->fetch_assoc()) {

                                                                ?>
                                                                <option value="<?php echo $unitDetails['id']; ?>">
                                                                    <?php echo $unitDetails['unit_name'] . ' / ' . $structureModel->getCompanyById($unitDetails['company_id'])['company_name']; ?>
                                                                </option>
                                                            <?php } ?>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select editField" name="manager_id"
                                                            id="manager_id">
                                                            <option value="0">
                                                                <?php echo (_lang['manager_add']); ?>
                                                            </option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select editField" name="activity_id"
                                                            id="activity_id">
                                                            <option value="0">
                                                                <?php echo (_lang['activity_add']); ?>
                                                            </option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select editField" name="company_id"
                                                            id="company_id">
                                                            <option value="0">
                                                                <?php echo (_lang['company_add']); ?>
                                                            </option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select editField" name="unit_id"
                                                            id="unit_id">
                                                            <option value="0">
                                                                <?php echo (_lang['unit_add']); ?>
                                                            </option>
