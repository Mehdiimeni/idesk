<?php
///template/structure/mark_list.php
?>
                            ...
                            <div class="table-responsive">
                                <table id="scroll-vertical-datatable"
                                    ...
                                    <tbody>
                                        ...
                                        while ($markListsDetails = $markListsResult->fetch_assoc()) {

                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $markListsDetails['id']; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$markListsDetails['mark_list_name']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $markListsDetails['mark_list_description']; ?>
                                                </td>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($markListsDetails['last_updated_date'], $config->getNowLanguage('a'));
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item"
                                                            ...
                                                            data-table="mark_list"
                                                            data-id="<?php echo $markListsDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="mark_list_description"
                                                            class="form-label"><?php echo (_lang['description']); ?>
                                                        </label>
