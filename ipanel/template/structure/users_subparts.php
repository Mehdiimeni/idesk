                                ...
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                            <td>
                                                    <?php echo $userSubPartsDetails['id']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userSubPartsDetails['users_subparts_name']; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$structureModel->getUserPartsById($userSubPartsDetails['users_parts_id'])['users_parts_name']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$userSubPartsDetails['users_subparts_caption']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userSubPartsDetails['users_subparts_description']; ?>
                                                </td>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($userSubPartsDetails['last_updated_date'], $config->getNowLanguage('a'));
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal" data-bs-target="#deleteModal" data-table="users_subparts" data-id="<?php echo $userSubPartsDetails['id']; ?>">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($rbacClass->checkPermissionOperationByName('edit_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal" data-bs-target="#editModal" data-table="users_subparts" data-id="<?php echo $userSubPartsDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <input type="hidden" class="form-control addField" name="table_set" id="tableSet" value="users_subparts">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control addField" name="users_parts_id" id="users_parts_id">
                                                            <?php
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="users_subparts_name" name="users_subparts_name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="users_subparts_caption" name="users_subparts_caption" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control addField" id="users_subparts_description" name="users_subparts_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control editField" name="users_parts_id" id="users_parts_id">
                                                            <?php
                                                            while ($userPartsDetails = $userPartsResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($userPartsDetails['id']); ?>">
                                                                    <?php echo ($userPartsDetails['users_parts_name']); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="users_subparts_name" name="users_subparts_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="users_subparts_caption" class="form-label">
                                                            <?php echo (_lang['caption']); ?>
                                                        </label>
                                                        <input type="text" class="form-control editField" id="users_subparts_caption" name="users_subparts_caption" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control editField" id="users_subparts_description" name="users_subparts_description" required></textarea>
                                                    </div>
