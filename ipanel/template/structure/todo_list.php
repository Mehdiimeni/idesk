<?php
///template/structure/todo_list.php
?>
                                ...
                                <table id="scroll-vertical-datatable"
                                    ...
                                    <tbody>
                                        ...
                                        while ($todoListsDetails = $todoListsResult->fetch_assoc()) {
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo $todoListsDetails['id']; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$todoListsDetails['todo_list_name']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $todoListsDetails['todo_list_description']; ?>
                                                </td>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($todoListsDetails['last_updated_date'], $config->getNowLanguage('a'));
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item"
                                                            ...
                                                            data-id="<?php echo $todoListsDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="todo_list_description"
