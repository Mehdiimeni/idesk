                                ...
                                <table id="scroll-vertical-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                            <td>
                                                    <?php echo $userPartsDetails['id']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userPartsDetails['users_parts_name']; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$structureModel->getUserGroupById($userPartsDetails['users_groups_id'])['users_groups_name']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo _lang[$userPartsDetails['users_parts_caption']]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $userPartsDetails['users_parts_description']; ?>
                                                </td>
                                                <td>
                                                    <?php $dateConverter = new DateConverter($userPartsDetails['last_updated_date'], $config->getNowLanguage('a'));
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal" data-bs-target="#deleteModal" data-table="users_parts" data-id="<?php echo $userPartsDetails['id']; ?>">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($rbacClass->checkPermissionOperationByName('edit_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal" data-bs-target="#editModal" data-table="users_parts" data-id="<?php echo $userPartsDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    ...
                                                    <input type="hidden" class="form-control addField" name="table_set" id="tableSet" value="users_parts">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control addField" name="users_groups_id" id="users_groups_id">
                                                            <?php
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="users_parts_name" name="users_parts_name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="users_parts_caption" name="users_parts_caption" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="users_parts_description" class="form-label">
                                                            <?php echo (_lang['description']); ?>
                                                        </label>
                                                        <textarea class="form-control addField" id="users_parts_description" name="users_parts_description" required></textarea>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control editField" name="users_groups_id" id="users_groups_id">
                                                            <?php
                                                            while ($userGroupsDetails = $userGroupsResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($userGroupsDetails['id']); ?>">
                                                                    <?php echo ($userGroupsDetails['users_groups_name']); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="users_parts_name" name="users_parts_name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="users_parts_caption" class="form-label">
                                                            <?php echo (_lang['caption']); ?>
                                                        </label>
                                                        <input type="text" class="form-control editField" id="users_parts_caption" name="users_parts_caption" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="users_parts_description" class="form-label">
                                                            <?php echo (_lang['description']); ?>
                                                        </label>
                                                        <textarea class="form-control editField" id="users_parts_description" name="users_parts_description" required></textarea>
                                                    </div>
