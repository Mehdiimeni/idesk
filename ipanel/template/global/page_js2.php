...
<?php } ?>
<?php if (in_array('range', $arrayComponents)) { ?>
    <script src="../itheme/panel/vendor/daterangepicker/moment.min.js"></script>
    <script src="../itheme/panel/vendor/daterangepicker/daterangepicker.js"></script>
<?php } ?>
...
<?php if (in_array('calendar', $arrayComponents)) { ?>
    ...
    <script src="../itheme/panel/js/iw/event.js"></script>
<?php } ?>
<?php if (in_array('date', $arrayComponents)) { ?>
    ...
    <script src="../itheme/panel/js/iw/date.js"></script>
...
<?php if (in_array('mask', $arrayComponents)) { ?>
    <script src="../itheme/panel/vendor/jquery-mask-plugin/jquery.mask.min.js"></script>
    <script src="../itheme/panel/js/iw/request_update.js"></script>
<?php } ?>

<?php if (in_array('confirm', $arrayComponents)) { ?>
    <script src="../itheme/panel/js/iw/request_confirmation.js"></script>
<?php } ?>
...
<?php if (in_array('cookie_list', $arrayComponents)) { ?>
    <script src="../itheme/panel/js/iw/cookie_list.js"></script>
<?php } ?>
...
<?php } ?>
<?php if (in_array('status', $arrayComponents)) { ?>
    <script src="../itheme/panel/js/iw/status.js"></script>
<?php } ?>
...
<?php if (in_array('chat', $arrayComponents)) { ?>
    <script src="../itheme/panel/js/iw/chat.js"></script>
<?php } ?>
