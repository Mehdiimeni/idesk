                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <?php echo ($structureModel->getCompanyById($admin->getUnitNameById($adminsDetails['unit_id'])['company_id'])['company_name']); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php if ($rbacClass->checkPermissionOperationByName('delete_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon delete-item" data-bs-toggle="modal" data-bs-target="#deleteModal" data-table="admins" data-id="<?php echo $adminsDetails['id']; ?>">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>
                                                    <?php } ?>
                                                    <?php if ($adminsDetails['status'] === 'Active') { ?>
                                                        <?php if ($rbacClass->checkPermissionOperationByName('inactive_operation')) { ?>
                                                            <a href="javascript:void(0);" class="action-icon inactive-item" data-bs-toggle="modal" data-bs-target="#inactiveModal" data-table="admins" data-id="<?php echo $adminsDetails['id']; ?>">
                                                                <i class="mdi mdi-smart-card"></i>
                                                            </a>
                                                        <?php } ?>
                                                    <?php } else { ?>
                                                        <?php if ($rbacClass->checkPermissionOperationByName('active_operation')) { ?>
                                                            <a href="javascript:void(0);" class="action-icon active-item" data-bs-toggle="modal" data-bs-target="#activeModal" data-table="admins" data-id="<?php echo $adminsDetails['id']; ?>">
                                                    ...
                                                    <?php if ($rbacClass->checkPermissionOperationByName('edit_operation')) { ?>
                                                        <a href="javascript:void(0);" class="action-icon edit-item" data-bs-toggle="modal" data-bs-target="#editModal" data-table="admins" data-id="<?php echo $adminsDetails['id']; ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="addForm" name="addForm" class="form-control">
                                                    <input type="hidden" class="form-control addField" name="table_set" id="tableSet" value="admins">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control addField" name="rbac_id" id="rbac_id">
                                                            <?php
                                                            $rbacResult = $structureModel->getRBAC();
                                                            while ($rbacDetails = $rbacResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($rbacDetails['id']); ?>">
                                                                    <?php echo ($rbacDetails['rbac_name']); ?> / <?php echo ($rbacDetails['company_name']); ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control addField" id="name" name="name" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control addField" id="mobile" name="mobile" type="tel" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email" class="form-label">
                                                            <?php echo (_lang['email']); ?>
                                                        </label>
                                                        <input class="form-control addField" id="email" name="email" type="email" required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control addField" id="password" name="password" type="password" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control addField" name="unit_id" id="unit_id">
                                                            <?php
                                                            ...
                                                            while ($unitsDetails = $unitsResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($unitsDetails['id']); ?>">
                                                                    ...
                                                                    <?php echo ($structureModel->getCompanyById($admin->getUnitNameById($unitsDetails['id'])['company_id'])['company_name']); ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="editForm" name="editForm" class="form-control">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control editField" name="rbac_id" id="rbac_id">
                                                            <?php
                                                            $rbacResult = $structureModel->getRBAC();
                                                            while ($rbacDetails = $rbacResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($rbacDetails['id']); ?>">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control editField" id="name" name="name" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="mobile" class="form-label">
                                                            <?php echo (_lang['mobile']); ?>
                                                        </label>
                                                        <input class="form-control editField" id="mobile" name="mobile" type="tel" required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control editField" id="email" name="email" type="email" required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control editField" id="password" name="password" type="password" required>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control editField" name="unit_id" id="unit_id">
                                                            <?php
                                                            $unitsResult = $structureModel->getUnits();
                                                            while ($unitsDetails = $unitsResult->fetch_assoc()) { ?>
                                                                <option value="<?php echo ($unitsDetails['id']); ?>">
